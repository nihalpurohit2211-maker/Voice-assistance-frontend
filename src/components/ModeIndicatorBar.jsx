...
export const MODES = {
    casual: {
        ...
        icon: Coffee,
        badgeBg: 'bg-sky-950/50 backdrop-blur-md',
    ...
    focused: {
        ...
        icon: Target,
        badgeBg: 'bg-amber-950/50 backdrop-blur-md',
    ...
    reflective: {
        ...
        icon: Heart,
        badgeBg: 'bg-purple-950/50 backdrop-blur-md',
    ...
    playful: {
        ...
        icon: Sparkles,
        badgeBg: 'bg-emerald-950/50 backdrop-blur-md',
        ...
        <div className="relative inline-flex items-center" ref={dropdownRef}>
            ...
            >
                ...
                <button
                    ...
                    className="relative group p-1 rounded-full hover:bg-white/10 transition-colors focus:outline-none flex items-center justify-center w-5 h-5"
            ...
            {dropdownOpen && (
                <div className="absolute top-full mt-2 left-0 w-60 bg-neutral-900/95 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl py-2 z-50 text-white animate-in fade-in zoom-in-95 duration-150">
                    ...
                    {Object.values(MODES).map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={`w-full px-3 py-2 text-left flex items-start space-x-2.5 transition-colors ${isSelected ? 'bg-white/10 font-medium' : 'hover:bg-white/5'}`}
                            >
