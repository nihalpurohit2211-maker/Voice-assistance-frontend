    ...
    return (
        <div className="min-h-screen w-screen text-neutral-100 flex items-center justify-center p-4 relative overflow-hidden font-sans" style={{ backgroundColor: 'var(--bg-base)' }}>
            ...
            <div 
                ...
                style={{ background: 'radial-gradient(circle, var(--mode-reflective) 0%, transparent 70%)' }}
            />

            <div className="max-w-md w-full relative z-10">
                {/* Brand / Header */}
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-white/5 border border-white/10 mb-4" style={{ boxShadow: '0 0 20px color-mix(in srgb, var(--mode-casual) 25%, transparent)' }}>
