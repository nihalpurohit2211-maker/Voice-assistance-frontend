            ...
            <div className="max-w-md w-full relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-xs sm:text-sm text-neutral-400 mt-1.5 font-light">
                        Get started with real-time AI voice conversations
                    </p>
                </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-xs sm:text-sm text-white placeholder-neutral-500 focus:outline-none focus:ring-1 focus:ring-emerald-400/80 focus:border-emerald-400/80 transition-all" 
                                />
                            </div>
                        </div>
